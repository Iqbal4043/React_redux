            ...
            <Navbar bg="dark" variant="dark" style={{height:60}}>
                ...
                >

                    {
                                                ...
                                                <>
                                                    <tr>
                                                        <td>
                                                            ...
                                                            <img src={e.imgdata} style={{width:"7rem", height:"7rem", padding:5}} alt="" /> </NavLink> 
                                                        </td>
                                                        <td>
                                                            <p>{e.rname}</p>
                                                            <p>Price : ₹{e.price}</p>
                        ...
                        <img src='./image/cart.gif' alt='img' className='emptycart_img ' style={{width:"5rem", padding: 10}}/>
                        </div>
                    }
